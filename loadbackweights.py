...
#
#
# with open('convlayerback5_3.txt', 'w') as outfile:
...
#     outfile.write('\n')
#     for i in range(convTensor.shape[2]):
#         for j in range(convTensor.shape[3]):
#             for k in range(convTensor.shape[0]):
#                 np.savetxt(outfile, convTensor[k,...,i,j], fmt='%-7.9f')
...
with open('convlayerback1_1.txt', 'w') as outfile:
...
with open('convlayerback1_2.txt', 'w') as outfile:
...
with open('convlayerback2_1.txt', 'w') as outfile:
...
with open('convlayerback2_2.txt', 'w') as outfile:
...
with open('convlayerback3_1.txt', 'w') as outfile:
...
with open('convlayerback3_2.txt', 'w') as outfile:
...
with open('convlayerback3_3.txt', 'w') as outfile:
...
with open('convlayerback4_1.txt', 'w') as outfile:
...
with open('convlayerback4_2.txt', 'w') as outfile:
...
with open('convlayerback4_3.txt', 'w') as outfile:
...
with open('convlayerback5_1.txt', 'w') as outfile:
...
with open('convlayerback5_2.txt', 'w') as outfile:
